...
- [Введение](#введение)
- [Документация по школе](#документация-по-школе)
- [Бассейн по языку Си](#бассейн-по-языку-си)
- [Основное обучение](#основное-обучение)
...
- [Oстальные бассейны Школы 42](#остальные-бассейны-школы-42)
- [Групповые проекты Школы 42(Rushes - миниХАКАТОНЫ)](#групповые-проекты-школы-42rushes---минихакатоны)
...
Последовательно двигаясь по направлениям, языкам и учебным проектам Школы 42, используя [карту проектов `Holy Graph`](./00_Projects/Holy_Graph.png), вы сформируете у себя фундаментальные технические навыки:
...
* Описание учебного курса школы: [[ en ]](./03_Norme/cursus_manual.en.pdf) [[ ru ]](./03_Norme/cursus_manual.ru.md)
* Информация о самой системе `peer-to-peer` обучения: [[ en ]](./03_Norme/the_art_of_peer_evaluation.EN.pdf) [[ ru ]](./03_Norme/the_art_of_peer_evaluation.RU.md)
* Подсказки по `Git` для взаимодействия с репозиторием в `Vogsphere`: [[ fr ]](./03_Norme/vogsphere.git.EN.pdf) [[ ru ]](./03_Norme/vogsphere.git.RU.md)
* Интерактивный тур, который познакомит вас с основами Git [[ru]](https://githowto.com/ru)
* Нормы, описывающие то, как нужно писать код: [[ fr ]](./03_Norme/norme_1_8.FR.pdf) [[ ru ]](./03_Norme/norme_1_8.RU.md)
* Проверка кода через `Norminette` [[ ru ]](./03_Norme/code-check_norminette.md)
* 10 правил, для тех кто начинает плавать в бассейне [[ ru ]](./03_Norme/10_rules_for_piscine.md)
...
- Бассейн по Си: [[ en ]](./00_Piscine_C)
- Экзаменационные задания начального бассейна по Си: [[ en ][ fr ][ ro ]](./00_Piscine_C/Exam_C)
...
[Проекты основного обучения](./00_Projects/)  представляют собой следующий этап обучения программированию. Все они сгруппированы по направлениям, которые представлены в виде ветвей. Помните, что каждый последующий проект выбранной вами ветки сложнее предыдущего и может быть решен только с помощью навыков полученных в предыдущих проектах.

Для продвижения по заданиям/проектам основного обучения Школы 42 используйте [карту проектов `Holy Graph`](./00_Projects/Holy_Graph.png) и [наглядную карту направлений `highlighting_branches`](./00_Projects/highlighting_branches_Holy_Graph.gif)

---
> ### [[GLOBAL - Общая ветвь]](./00_Projects/00_Global_(begin_cadet)/)
---
...
> ### [[Ветвь UNIX]](./00_Projects/01_Unix/)
---
...
>     - [[>]](./00_Projects/01_Unix/12_2_6____kfs-7) KFS-7
...
> ### [[Ветвь Алгоритмов]](./00_Projects/02_Algorithmic/)
---
...
> ### [[Ветвь Графики]](./00_Projects/03_Graphic/)
---
...
> ### [[Системное & Сетевое Администрирование]](./00_Projects/05_Infrastructure_and_Admin/)
---
...
> ### [[Android & iOS ветвь]](./00_Projects/06_Android-iOS/)
---
...
> ### [[C++ ветвь]](./00_Projects/07_CPP/)
---
> - [[>]](./00_Projects/07_CPP/00____module_cpp_(its_the_same_as_a_picsine_cpp_but_new_version)) modules С++ (это то же самое, что и `piscine C++`, но новая версия)
> - [[>]](./00_Projects/07_CPP/00____piscine_cpp_(its_the_same_as_a_module_cpp_but_old_version)) piscine C++ (это то же самое, что и `modules С++` но старая версия)
...
> ### [[Unity ветвь]](./00_Projects/08_Unity/)
---
...
> ### [[OCaml ветвь]](./00_Projects/09_OCaml/)
---
...
> ### [[Ai Projects - Искуственный интелект]](./00_Projects/10_Ai/)
---
...
> ### [[Side Projects - Сторонние Проекты]](./00_Projects/11_Side_Projects/)
---
